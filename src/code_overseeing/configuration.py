    ...
    def _parse_optional_int(value) -> Optional[int]:
        ...
        if isinstance(value, str):
            ...
            try:
                ...
                raise ValueError(f"Optional value must be an integer or empty string or null, got '{value}'")
        if isinstance(value, (int, float)):
            return int(value)
        raise ValueError(f"Optional value must be an integer or empty string, got '{value}'")