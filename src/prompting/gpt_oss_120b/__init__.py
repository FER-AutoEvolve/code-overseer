...
from prompting.gpt_oss_120b.prompts import GetCodeChangeCommandsPrompt, GetCodeChangeCommandsReprompt, GetCodeFixCommandsPrompt
import logging
import openai
...
class PromptManager(BasePromptManager):
    '''
    Manages prompts to the GPT OSS 120B API.
    Attributes:
        _gpt_oss_configuration (GptOss120bConfiguration): Configuration for GPT OSS 120b API access.
        _logger (logging.Logger): Logger for logging information and errors.
    '''
    _gpt_oss_configuration: GptOss120bConfiguration = dataclasses.field(init=False)
