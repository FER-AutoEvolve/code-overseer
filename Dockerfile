...
ARG CODE_BUILD_TESTING_MAX_BUILD_ATTEMPTS="5"
...
ENV CODEBASE_DESCRIPTION=${CODEBASE_DESCRIPTION} \
    ...
    REPROMPT_MAX_ATTEMPTS=${REPROMPT_MAX_ATTEMPTS} \
    ...
    CODE_BUILD_TESTING_ENABLE=${CODE_BUILD_TESTING_ENABLE} \
    CODE_BUILD_TESTING_ENDPOINT=${CODE_BUILD_TESTING_ENDPOINT} \
    CODE_BUILD_TESTING_TIMEOUT=${CODE_BUILD_TESTING_TIMEOUT} \
    CODE_BUILD_TESTING_MAX_BUILD_ATTEMPTS=${CODE_BUILD_TESTING_MAX_BUILD_ATTEMPTS} \
