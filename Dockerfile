...
ENV CODEBASE_DESCRIPTION=${CODEBASE_DESCRIPTION} \
    ...
    CODE_BUILD_TESTER_ENABLE=${CODE_BUILD_TESTER_ENABLE} \
    CODE_BUILD_TESTER_ENDPOINT=${CODE_BUILD_TESTER_ENDPOINT} \
    CODE_BUILD_TESTER_TIMEOUT=${CODE_BUILD_TESTER_TIMEOUT} \
    PROMPTING_HEADERS=${PROMPTING_HEADERS}
